---
description: Systematic Nezha Monitoring V2 Agent startup and connectivity troubleshooting for network, port, TLS, connection secret, UUID, service status, logs, and Dashboard settings.
outline: deep
---

...
::: warning
The original content of this page applied to the v0 OAuth2 configuration format and does not apply to v1 or later. This page is kept only to preserve old links; do not use the old configuration format for new Cloudflare Access login setups.
:::

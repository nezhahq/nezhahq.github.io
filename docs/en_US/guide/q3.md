---
description: Configure Nginx or Caddy as a Nezha Monitoring V2 Dashboard reverse proxy with correct HTTP, WebSocket, Agent gRPC, TLS, and authentication-header forwarding.
outline: deep
---

# Dashboard Reverse Proxy Configuration

In Nezha Monitoring V2, Dashboard web access and Agent gRPC communication can share the default `8008` port.

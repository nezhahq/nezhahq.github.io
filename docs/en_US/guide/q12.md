...
Configure this in the admin frontend under **avatar → System Settings → System Configuration → Frontend Real IP Request Header**. The corresponding configuration file field is [`web_real_ip_header`](/en_US/configuration/dashboard.html#web-real-ip-header).

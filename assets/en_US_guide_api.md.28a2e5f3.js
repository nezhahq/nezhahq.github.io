...
</code></pre></div><h2 id="case-build-your-own-telegram-bot-to-query-server-information" tabindex="-1">Case - Build your own Telegram bot to query server information <a class="header-anchor" href="#case-build-your-own-telegram-bot-to-query-server-information" aria-hidden="true">#</a></h2><p>Refer to <a href="https://github.com/spiritLHLS/nezha_api_tgbot" target="_blank" rel="noopener noreferrer">Community Project</a> (Chinese)<br> The bot can request server status information from the Dashboard through the API, and then send the information to the user.<br> You can build this bot to easily view the current status of a given server without opening the Dashboard.</p>`,18),a=[q];function r(i,s,d,l,c,h){return e(),o("div",null,a)}var v=t(n,[["render",r]]);export{m as __pageData,v as default};
